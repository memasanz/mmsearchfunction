...
def text_split_embedd(relevant_data, filename):
    #relevant_data = normalize_text(relevant_data)
    ...
    updated_texts = []
    for t in texts:
        t = "Text applies to part number: " + filename + '\n' +  t
        updated_texts.append(t)

    df = pd.DataFrame(updated_texts, columns =['text'])
...
def transform_value(value):
    ...
    try:                
        ...
        data, embeddings = text_split_embedd(searchresults, filenoextension)
